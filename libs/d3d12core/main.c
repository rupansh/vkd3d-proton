...
/* Helios: the debug-control facility moved to debug_control.c so that the
 * Helios static arm can link the five predicates libvkd3d calls without
 * pulling in this object and its CreateDXGIFactory1 import.  See that file. */
